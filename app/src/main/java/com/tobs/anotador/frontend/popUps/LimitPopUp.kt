...
class LimitPopUp(private val callingClass: Class<out GameActivity>) : DialogFragment(), DialogInterface.OnDismissListener {
    ...
    override fun onDismiss(dialog: DialogInterface) {
        ...
        if(used) {
            listener?.getPlayerCount(limit, callingClass)
        }
    }
